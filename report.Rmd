...
There's a good balance between positive and negative words in each speech. Around 75% positive and 25% negative. It's a good ratio, given that an inaugural speech should motivate, but also remind us of the challenges to be overcome in the coming years.
```{r}
...
The importance of citizens in a republic is demonstrated by the red indicator at the bottom, which is the most important on this network.
Finally, the famous French quote 'Liberté, Egalité, Fraternité' is present in this network, but without the word 'Fraternité'. Why is this? Is it because the elected candidate doesn't want to consider all citizens as brothers because they didn't all vote for him?
